  ...
  if (groupSnippets.length > 0) {
    ...
    for (const cluster of groupSnippets) {
      ...
      for (const snippet of cluster.snippets) {
        ...
        thumb.style.height = "fit-content";// todo: does not work in safari
        if (forMobile) thumb.style.maxHeight = "60px";
...
function renderMobileNavBarFlexible(printess: iPrintessApi, buttons: Array<iExternalButton>) {
